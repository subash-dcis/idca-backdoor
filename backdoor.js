...
(function () {
        ...
        document.getElementById('oId').setAttribute('value', document.getElementById('oId').value);
        document.getElementById('sName').setAttribute('value', document.getElementById('sName').value);
        document.getElementById('hData').setAttribute('value', document.getElementById('hData').value);
